...
| :--- | :--- | :--- |
| Zero ads, direct HLS (`.m3u8`), MP4 & MKV streams extracted from multi-server backends | Sub-second response times with cached fuzzy matching and live AJAX lookups | Just copy the repository manifest URL and paste into Nuvio Settings |
...
4. Tap **Add** and toggle your preferred providers on or off.

---

## 📚 Plugin Catalog

### ☀️ Kurdish Cinema & TV (کوردستان)

Dedicated providers featuring Kurdish (Sorani) subtitled and dubbed movies, series, and multi-server players:
...
### 🌸 Anime, Cartoons & Asian Dramas

Dedicated sources for Japanese Anime, East Asian Dramas, and nostalgic Arabic dubbed animations:
...
| <img src="https://www.google.com/s2/favicons?domain=arabic-toons.com&sz=256" width="22" height="22" /> [**ArabicToons**](https://arabic-toons.com) | 🇪🇬 🇸🇦 | Arabic Dubbed Anime & Cartoons | **1080p** | `mp4` |
...
> **No media content is stored or hosted on this repository.**

- All providers are pure JavaScript web scrapers that fetch publicly accessible links from third-party websites.
- This repository is maintained as an open-source project strictly for **educational and research purposes**.
- Users are solely responsible for compliance with local copyright laws and regulations in their jurisdiction.
- If you have DMCA or copyright concerns, please contact the third-party web hosts directly.

---

## 🤝 Community & Credits

Special appreciation to the open-source streaming community, contributors, and reverse-engineers who make these plugins possible:
...
**© CHYA Plugins** · Crafted with precision for the streaming community · Educational purposes only
